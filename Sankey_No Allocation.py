...
data=pd.read_excel( 'Sankey_Test.xlsx',sheet_name='N30')
# 生成links
links = []
...
pic=(
     ...
     .set_global_opts(title_opts=opts.TitleOpts(title="N30 Paper MFA 1961-2019"))
     )

pic.render('OUT/Sankey_N30_1961-2019_Test.html')
